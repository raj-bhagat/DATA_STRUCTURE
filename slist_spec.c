...
void test_addition_at_head()
{
	...
	//	printf("%d->",cur->data);
	//}
	list= slist_add_head(list,60);
	list= slist_add_head(list,50);
	Slist s2 = slist_new();
	Slist *list3 = &s2;
	//list3= slist_union(list, list2);
	//list3= slist_intersection(list, list2);
	list3 = slist_unique_list(list3, 10);
	list3 = slist_unique_list(list3, 20);
	list3 = slist_unique_list(list3, 30);
	list3 = slist_unique_list(list3, 40);
	//list3 = slist_unique_list(list3, 20);
	list3= slist_reverse(list3);
	for(cur=list3->head;cur!=NULL;cur=cur->next){
		printf("%d->",cur->data);
	}
}
int main()
